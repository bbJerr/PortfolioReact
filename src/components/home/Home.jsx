  ...
  return (
    <section className="home" id="home">
      <div className="content">
        ...
        <h3>
          A <span className="typing-text" ref={typingTextRef}></span>
        </h3>
        ...
        <div className="social-icon">
          <a
            href="https://www.linkedin.com/in/jerra-kirsten-javier-8982792b2/"
            target="_blank"
          >
            <FaLinkedin />
          </a>
          <a
            href="https://www.facebook.com/jerrakirsten.javier"
            target="_blank"
          >
            <FaFacebook />
          </a>
